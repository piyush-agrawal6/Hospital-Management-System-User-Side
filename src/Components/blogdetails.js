                  ...
                  <div className="ttr-post-text">
                    ...
                    <ul className="wp-block-gallery columns-6 is-cropped">
                      <li className="blocks-gallery-item">
                        <img src={Cardm1} alt="img" />
                      </li>
                      <li className="blocks-gallery-item">
                        <img src={Cardm2} alt="img" />
                      </li>
                    </ul>
                    <p>
                      You just need to enter the keyword and select the keyword
                ...
                <div className="widget widget_gallery gallery-grid-3">
                  ...
                  <div>
                    <ul className="magnific-image">
                      ...
                      <li>
                        <img src={Cardm3} alt="img" />
                      </li>
                      <li>
                        <img src={Cardm4} alt="img" />
                      </li>
                      <li>
                        <img src={Cardm5} alt="img" />
                      </li>
                      <li>
                        <img src={Cardm6} alt="img" />
                      </li>
                    </ul>
                  </div>
                </div>
